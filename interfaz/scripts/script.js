...
function realizarOperacion() {
  ...
  if (n1 != null && n2 != null) {
     ...
     enviarOperacion(operacionActual, n1, n2);
...
// Funcion para enviar la operacion designada al orquestador

function enviarOperacion(operacion, val1, val2){

  var url = "http://localhost:2020/api/operacion";
  console.log(operacion, val1, val2)
  fetch(url, {
    method: "POST",
    headers: {
